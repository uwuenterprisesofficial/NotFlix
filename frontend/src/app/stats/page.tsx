...
export default async function StatsPage() {
  const stats = await apiOrNull<Stats>("/me/stats");
  if (!stats) {
    return (
  ...
  if (o.total === 0) {
    return (
      <div className="mx-auto mt-40 max-w-lg rounded-lg bg-surface-raised p-8 text-center">
        <h1 className="text-2xl font-bold">Statistics</h1>
        <p className="mt-3 text-muted">Press “Sync MAL” to import your list first.</p>
      </div>
    );
  }

  return (
    <div className="mx-auto max-w-6xl space-y-10 px-4 pt-24 pb-16 md:px-12">
      <header>
